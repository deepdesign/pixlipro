  ...
  return (
    <span
      ...
      className={clsx(
        ...
        '*:data-[slot=icon]:text-[var(--text-subtle)]'
      )}
    >
      {children}
    </span>
  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'dark:before:hidden',
        // Focus ring
        'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-[var(--accent-primary)]',
        // Disabled state
