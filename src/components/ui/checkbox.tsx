...
const base = [
  ...
  'before:absolute before:inset-0 before:-z-10 before:rounded-[calc(0.3125rem-1px)] before:bg-[var(--checkbox-bg)] before:shadow-sm',
  // Background color when checked
  'group-data-checked:before:bg-(--checkbox-checked-bg)',
  // Background color is moved to control and shadow is removed in dark mode so hide `before` pseudo
  'dark:before:hidden',
  // Background color applied to control in dark mode
  'bg-[var(--checkbox-bg)] group-data-checked:bg-(--checkbox-checked-bg)',
  // Border
  'border border-[var(--checkbox-border)] group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-[var(--select-hover)] group-data-checked:bg-(--checkbox-checked-border)',
...
const colors = {
  'dark/zinc': [
    '[--checkbox-check:var(--text-primary)] [--checkbox-checked-bg:var(--theme-primary-panel)] [--checkbox-checked-border:var(--theme-primary-bg-base)]',
    '[--checkbox-checked-bg:var(--theme-primary-border)]',
  ],
  'dark/white': [
    '[--checkbox-check:var(--text-primary)] [--checkbox-checked-bg:var(--theme-primary-panel)] [--checkbox-checked-border:var(--theme-primary-bg-base)]',
    '[--checkbox-check:var(--text-primary)] [--checkbox-checked-bg:var(--theme-supporting-light)] [--checkbox-checked-border:var(--theme-primary-border)]',
  ],
  white:
    '[--checkbox-check:var(--text-primary)] [--checkbox-checked-bg:var(--theme-supporting-light)] [--checkbox-checked-border:var(--theme-primary-border)]',
  dark: '[--checkbox-check:var(--text-primary)] [--checkbox-checked-bg:var(--theme-primary-panel)] [--checkbox-checked-border:var(--theme-primary-bg-base)]',
  zinc: '[--checkbox-check:var(--text-primary)] [--checkbox-checked-bg:var(--theme-primary-border)] [--checkbox-checked-border:var(--theme-primary-border)]',
