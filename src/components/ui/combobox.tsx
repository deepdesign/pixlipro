      ...
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            ...
            // Disabled state
            'data-disabled:border-[var(--select-border)] data-disabled:bg-[var(--select-bg)]',
            // System icons
            'dark:scheme-dark',
          ])}
        />
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-[var(--text-subtle)] group-data-disabled:stroke-[var(--text-muted)] group-data-hover:stroke-[var(--text-primary)] sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
