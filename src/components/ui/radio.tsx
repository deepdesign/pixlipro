...
const base = [
  ...
  'before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-[var(--checkbox-bg)] before:shadow-sm',
  // Background color when checked
  'group-data-checked:before:bg-(--radio-checked-bg)',
  // Background color is moved to control and shadow is removed in dark mode so hide `before` pseudo
  'dark:before:hidden',
  // Background color applied to control in dark mode
  'bg-[var(--checkbox-bg)] group-data-checked:bg-(--radio-checked-bg)',
  // Border
  'border border-[var(--checkbox-border)] group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-[var(--select-hover)] group-data-checked:bg-(--radio-checked-border)',
...
const colors = {
  'dark/zinc': [
    '[--radio-checked-bg:var(--theme-primary-panel)] [--radio-checked-border:var(--theme-primary-bg-base)] [--radio-checked-indicator:var(--text-primary)]',
    '[--radio-checked-bg:var(--theme-primary-border)]',
  ],
  'dark/white': [
    '[--radio-checked-bg:var(--theme-primary-panel)] [--radio-checked-border:var(--theme-primary-bg-base)] [--radio-checked-indicator:var(--text-primary)]',
    '[--radio-checked-bg:var(--theme-supporting-light)] [--radio-checked-border:var(--theme-primary-border)] [--radio-checked-indicator:var(--text-primary)]',
  ],
  white:
    '[--radio-checked-bg:var(--theme-supporting-light)] [--radio-checked-border:var(--theme-primary-border)] [--radio-checked-indicator:var(--text-primary)]',
  dark: '[--radio-checked-bg:var(--theme-primary-panel)] [--radio-checked-border:var(--theme-primary-bg-base)] [--radio-checked-indicator:var(--text-primary)]',
  zinc: '[--radio-checked-indicator:var(--text-primary)] [--radio-checked-bg:var(--theme-primary-border)] [--radio-checked-border:var(--theme-primary-border)]',
