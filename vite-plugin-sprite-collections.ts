...
export default function spriteCollectionsPlugin(): Plugin {
  // Use process.cwd() to get the actual working directory (where npm/vite is run from)
  // This ensures it works correctly in production builds where __dirname might resolve differently
